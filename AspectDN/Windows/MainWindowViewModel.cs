...
namespace AspectDN.Wnd
{
    public class MainWindowViewModel : INotifyPropertyChanged
    {
        ...
        public ObservableCollection<TaskEvent> WeaveAspectDNProject_Events
        {
            get => _WeaveAspectDNProject_Events;
        }
        ...
        {
            // ajout
            //App.Current.Dispatcher.Invoke(() => { WeaveAspectDNProject_Events.Add(eventLoggerArgs.TaskEvent); });
            _Window.Dispatcher.Invoke(() => { WeaveAspectDNProject_Events.Add(eventLoggerArgs.TaskEvent); });
